...
pub fn tos() -> Html {
    html! {
        <div class = "container-fluid">
            ...
            <h4>{"II: "}</h4>{"holi ist ein unabhängiges System, dass einen Austausch von Lehrmitteln ermöglichen will. holi agiert als eigene Instanz, trotz Kooperation mit der HTL Hollabrunn und Ihrer Schülervertretung."}<br /><br />
